...
const Hero = () => {
  return (
    <div id="home" className="w-screen mb-12 flex flex-col items-center">
        {/* Picture of Me */}
        <Image src={require('../assets/profilepic.png')} alt="profile pic of Rachel"  className="mt-14 sm:w-96 w-72"/>
        <p className="sm:text-6xl text-5xl mt-2 text-[#414141] font-serif">Rachel Howell</p>
        <p className="text-2xl mt-4 font-mono text-[#414141] text-wrap px-1 text-center">Full Stack Software Engineer</p>
